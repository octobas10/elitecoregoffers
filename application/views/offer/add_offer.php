		...
		<div class="portlet light">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="form-horizontal form-bordered">
					<div class="form-body">
						<div class="form-group">
							<label class="control-label col-md-3">Offer Content (Ad Copy)</label>
							<div class="col-md-9">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="form-horizontal form-bordered">
					<div class="form-body">
						...
						<!-- title -->
						<div class="form-group" id="field_2">
							<h4 class="block"></h4>
							<div class="col-md-3">
								<div class="md-checkbox-list">
									<div class="md-checkbox pull-left"><label><b>Input Type</b></label></div></div>
							</div>
							<div class="col-md-3">
								<div class="md-checkbox-list">
									<div class="md-checkbox pull-left"><label><b>Name of the Input</b> ( like emailaddr, Which we be posted & Should from client posting docs)</label></div></div>
							</div>
							<div class="col-md-6">
								<div class="md-checkbox-list">
									<div class="md-checkbox pull-left"><label><b>Caption Or Placeholder </b> (Like Email Address etc.) Or <b>Value Of an Input (When field type is Fixed/Other)</b> (like vid = 11001 etc)</label></div></div>
							</div>
						</div>
						<!-- /*USER FORM -->
						<div id="offer-form-elements">
							...
							//echo '<pre>';print_r($offer_layout);exit;
							$count = 1;
							$required ='';
							$hidden = '';
							foreach ($offer_layout as $key=>$value){
								...
								switch($value->fieldtype){
									...
									case"selectbox":
										...
										foreach ($value->value->values as $rkey=>$rvalue){
										$key_opt=isset($value->value->keys[$rcount-1]) ? $value->value->keys[$rcount-1] : $rvalue;	
										$checked = ($rkey==$check_selected) ? "checked" : '';
										if($rcount > 1)
										{
											$field .= "<div class='form-group form-md-radios border-none' id='form-selectbox-".$count."-".$rcount."'>	<div class='md-radio-inline border-none'>	<div class='col-md-2'><div class='md-radio pull-left mrleftn17'> <input type='radio' id='field_".$count."_radio_".$rcount."' name='userform[field_".$count."][value][checked]' value='0' class='md-radiobtn' ".$checked."> <label for='field_".$count."_radio_".$rcount."'> <span></span<span class='check'></span> <span class='box'></span>Op".$rcount."	</label></div></div><div class='col-md-3'><input type='text' class='form-control' name='userform[field_".$count."][value][keys][]' value='".$key_opt."' placeholder='Field Value'></div><div class='col-md-4'><input type='text' class='form-control' name='userform[field_".$count."][value][values][]' value='".$rvalue."' placeholder='Field Value'>	</div>	<div class='col-md-3'><a href=\"javascript:;\" class=\"btn btn-icon-only purple\" onclick=\"remove_field('form-selectbox-".$count."-".$rcount."');\"><i class=\"fa fa-times\"></i></a>	</div>	</div></div>";
										}
										else
										{
											$field .= "<div class='form-group form-md-radios border-none' id='form-selectbox-".$count."-".$rcount."'>	<div class='md-radio-inline border-none'>	<div class='col-md-2'><div class='md-radio pull-left mrleftn17'> <input type='radio' id='field_".$count."_radio_".$rcount."' name='userform[field_".$count."][value][checked]' value='0' class='md-radiobtn' ".$checked."> <label for='field_".$count."_radio_".$rcount."'> <span></span><span class='check'></span> <span class='box'></span>Op".$rcount."	</label></div></div><div class='col-md-3'><input type='text' class='form-control' name='userform[field_".$count."][value][keys][]' value='".$key_opt."' placeholder='Field Value'></div><div class='col-md-4'><input type='text' class='form-control' name='userform[field_".$count."][value][values][]' value='".$rvalue."' placeholder='Field Value'></div>	<div class='col-md-1'></div></div></div>";
										}
										$rcount++;
										}

		...
		success:function(res){
			...
			switch(field_name){
					...
					break;
                     ...
                     case"date-picker":
                        field += "<div class=\"form-group\" id=\"field_"+count+"\">";
						field += "							<h4 class=\"block\">Date Selector</h4>";
						field += "							<div class=\"col-md-3\">";
						field += "								<div class=\"md-checkbox-list\">";
						field += "									<div class=\"md-checkbox pull-left\">";
						field += "										<input type=\"checkbox\" id=\"field_"+count+"_required\" name=\"userform[field_"+count+"][required]\" value=\"1\" class=\"md-check\">";
	        ...
	        $.ajax({
		    		...
		    		success:function(res){		    			        
				    			if(res.flag==1){
	                                ...
	                                $('#d_select_field').html(s_system_keyword+(i_other_date_format_selected == 0 ? '<option value="other_date_format">DOB Other Format</option>' : '' ));   			      
				    			}else{
				    				$('.d_new_added_field').html('<tr><td colspan="2">No Record Found.</td></tr>'); 
				    			}
		    		}
    ...
    $(document).on('change','#d_select_field',function(){
        ...
        if(field_value!=''){
            if(field_value == 'other_date_format'){
                ...
                $('.d_new_ajax_block').html('<div class="d_new_child_field d_new_ajax"><label class="control-label">DOB Day <span class="required"	aria-required="true"> * </span></label><div class="input-icon right"><i class="fa"></i> <input type="text" class="form-control" id="d_key_value" name="site_name" value=""><label class="control-label">DOB Month <span class="required" aria-required="true"> * </span></label><div class="input-icon right"><i class="fa"></i> <input type="text" class="form-control" id="m_key_value" name="site_name" value=""><label class="control-label">DOB Year <span class="required"	aria-required="true"> * </span></label><div class="input-icon right"><i class="fa"></i> <input type="text" class="form-control" id="y_key_value" name="site_name" value=""></div></div>');
            }else{
